function add_confirmation_dialog(action, button){
    $('#'+button).click(function(event){
        ...
        delete_form = '<form method="post" action="' + action + '"><br><button type="submit" class="btn btn-small btn-inverse">Yes</button>&nbsp;<button id="cancel" type="button" class="btn btn-small btn-inverse">Cancel</button></form>';
